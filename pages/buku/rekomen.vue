<template>
  <div class="container-fluid">
    <div style="background-color: #4377de">
      ...
      <div class="ms-3 text-white fs-6">Menampilkan {{ books.length }} Dari {{ Semua }}</div>
      <div class="row mt-5">
        <div v-for="(book, i) in books" :key="i" class="col-3 d-flex flex-column justify-content-center align-items-center">
          <div class="card mb-3" style="width: 16rem">
            <div class="card-header" style="height: 350px">
              ...
              <div class="card-body">
                <h5 class="card-title text-center">{{ book.judul }}</h5>
...
<script setup>
useHead({
  title: "Rekomendasi- Perpus Digital Zulpa"
})
