...
<template>
  <div class="container-fluid">
    ...
    <div class="row">
      ...
      <div class="col-4 d-flex flex-column justify-content-center align-items-center">
        <button id="myInput"data-bs-toggle="modal" data-bs-target="#exampleModal" type="submit" class="btn btn-lg text-white mb-4" style="background-color: #123577; width: 200px;">Meminjam</button>
