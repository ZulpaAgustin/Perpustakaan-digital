  ...
  <div class="container-fluid">
    <div class="row justify-content-between">
      <div class="col-1">
        <div class="icon">
          <nuxt-link to="/">
            <svg aria-label="icon" xmlns="http://www.w3.org/2000/svg" width="50" height="80" fill="currentColor" class="bi bi-person-vcard-fill text-white" viewBox="0 0 16 16">
              <path aria-label="formulir"
...
<script setup>
useHead({
  title: "Menu - Perpus Digital Zulpa"
})
</script>
